 ...
 */
public class ForumsOfMyselfFragment extends BaseFragment<ICircleFriendsView,CircleFriendsPresenter> implements ICircleFriendsView {
...
//                })
                .addLoadMoreWrapper(new LoadMoreWrapper.OnLoadMoreListener() {
                    ...
                    public void onLoadMoreRequest(LoadMoreWrapper wrapper, int nextPage) {
                        getPresenter().loadForumAllData(nextPage,wrapper,1);
                    }
                })
                .create();
