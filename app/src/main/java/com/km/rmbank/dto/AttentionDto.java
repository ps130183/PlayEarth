...
public class AttentionDto implements Parcelable,ItemDelegate {
    ...
    public int getItemViewRes() {
        return R.layout.item_rv_my_attention;
    }
    ...
    protected AttentionDto(Parcel in) {
    ...
    public static final Creator<AttentionDto> CREATOR = new Creator<AttentionDto>() {
        @Override
        public AttentionDto createFromParcel(Parcel source) {
            return new AttentionDto(source);
        }

        @Override
        public AttentionDto[] newArray(int size) {
            return new AttentionDto[size];
        }
    };
}
