package com.km.rmbank.oldrecycler.rcline;
...
/**
 * Created by kamangkeji on 17/2/23.
 */
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    * */
    ...
    public DividerItemDecoration(Context context, int orientation, int color, int mItemSize, LineType lineType) {
