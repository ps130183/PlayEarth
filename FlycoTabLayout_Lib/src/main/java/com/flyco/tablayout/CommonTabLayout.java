...
import com.flyco.tablayout.utils.CommonFragmentChangeManager;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    private CommonFragmentChangeManager mFragmentChangeManager;
    ...
    public void setTabData(ArrayList<CustomTabEntity> tabEntitys, FragmentActivity fa, int containerViewId, ArrayList<Fragment> fragments) {
        mFragmentChangeManager = new CommonFragmentChangeManager(fa.getSupportFragmentManager(), containerViewId, fragments);
        ...
        tabView.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mCurrentTab != position) {
                    if (mListener != null && mListener.onTabSelect(position)) {
...
//        Log.d("AAA", "mCurrentP--->" + mCurrentP.left + "&" + mCurrentP.right);
    ...
    public void setCurrentTab(int currentTab) {
        ...
        if (mFragmentChangeManager != null) {
            mFragmentChangeManager.setFragments(mFragmentChangeManager.getViewHolder(currentTab));
