...
public class WheelTime {
    ...
    public void setWv_month(int wv_month) {
        this.wv_month.setCurrentItem(wv_month);
    }

    public void setWv_day(int wv_day) {
        this.wv_day.setCurrentItem(wv_day);
    }

    public void setWv_hours(int wv_hours) {
        this.wv_hours.setCurrentItem(wv_hours);
    }

    public void setWv_mins(int wv_mins) {
        this.wv_mins.setCurrentItem(wv_mins);
    }
}
