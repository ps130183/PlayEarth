...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public void setRange(String curTime,String format){
        Date curDate = new Date(stringDateToMillis(curTime,format));
        wheelTime.setStartYear(curDate.getYear());
        wheelTime.setEndYear(curDate.getYear());
        wheelTime.setWv_month(curDate.getMonth());
        wheelTime.setWv_day(curDate.getDay());
        wheelTime.setWv_hours(curDate.getHours());
        wheelTime.setWv_mins(curDate.getMinutes());
    }
